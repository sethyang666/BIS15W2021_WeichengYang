...
1. What is a vector in R?  "Vectors are a common way of organizing data in R.  We create vectors using the `c` command. The `c` stands for concatenate."

2. What is a data matrix in R?  "Combinations of vectors"
...
```r
springs_matrix1 <- cbind(springs_matrix, mean_vector)
springs_matrix1
```
