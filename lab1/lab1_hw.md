...
**2. What is the difference between R and RStudio? What is GitHub and why is it useful to programmers?**  R is just an open source and Rstudio has better user interface but only can be installed after R.
